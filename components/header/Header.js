        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex items-center flex-col p-4 mt-4 bg-body rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
            ...
            <li>
              ...
              <a  className="block text-secondary text-small text-x py-2 pr-4 pl-3  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-primary md:p-0 ">Experience</a>
              </Link>
            </li>
            <li>
              <Link href="/work">
              <a  className="block text-secondary text-small text-x py-2 pr-4 pl-3  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-primary md:p-0 ">Work</a>
              </Link>
            </li>
            <li>
              <Link href="/contact">
              <a  className="block text-secondary text-small text-x py-2 pr-4 pl-3  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-primary md:p-0 ">Contact</a>
              </Link>
            </li>
